...
public class QSEditor_QuickGizmo : Editor {
	...
	public bool showHelp;
        ...
        "\n\n1. Gizmos are only seen in the editor.They are useful for locating empty game objects in the scene, defining collider boundaries and drawing lines between objects." +
