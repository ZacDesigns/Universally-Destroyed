...
public class QSEditor_QuickTeleport : Editor {
   ...
   { "m_Script",
    ...
    static string helpText = "Quick Tips:" +
        ...
        "\n\n4. Teleported objects will face the same way as the node they teleport to.The direction the node is facing is indicated by the small line protruding from it." +
